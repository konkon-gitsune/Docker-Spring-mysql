...
import com.docker.exception.InvalidTransactionReferenceException;
import com.docker.model.Transaction;
import com.docker.service.TransactionService;
...
public class TransactionController {
	...
	public Transaction viewTransactionById(@PathVariable("id") Long id) {
		Optional<Transaction>transactions = transactionService.getTranscation(id);
